...
Print these pages separately or keep them together as the table packet. The
book remains playable with ordinary paper if no cards or app are available.
...
[ ] GM Deck Register
[ ] Active Cell Cards
[ ] Clock and Resource Cards
[ ] Delta and Trace Cards
[ ] Secret envelopes
[ ] Land and Loot Cards
```
