...
```text
declare intent
-> check deterministic physics
-> declare cost and boundary
-> choose capacity and help
...
## Computational interaction card
...
Visible state: _________________
Hidden state: __________________
Primary die: ___________________
...
```text
Identity: _____________________
...
Failure: ______________________
